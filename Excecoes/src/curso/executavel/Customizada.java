	...
	public static void main(String[] args) {
		try {
			...
			Scanner scanner = new Scanner(fil);
				...
				throw new ExcecaoProcessarNota(e.getMessage()); //O Throw é para lançar/jogar a exceção
		...
		} finally {// Sempre é executado ocorrendo erros ou não. Porque sempre é executado quando
					// se precisa executar um processo acontencendo ou não um erro no sistema. Ex:
